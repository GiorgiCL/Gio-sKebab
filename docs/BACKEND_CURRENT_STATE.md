...
| `GET /api/public/menu` | Ordered active categories with active items. Each public item includes ID, name, description, `priceEur`, `available`, `featured`, and nullable `imageUrl`. |
